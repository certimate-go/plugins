...
func TestDeploy_EnvGated(t *testing.T) {
	fp.Parse()
	if fAccessKeyId == "" || fAccessKeySecret == "" || fTestCertPath == "" || fTestKeyPath == "" || fDomain == "" {
		t.Skip("requires WANGSUCDN_ credentials and test cert paths")
	}
	...
	t.Run("Deploy_ToDomains", func(t *testing.T) {
